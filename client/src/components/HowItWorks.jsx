              ...
              return (
                <div
                  ...
                  className={`group relative flex gap-6 items-start p-5 rounded-2xl cursor-pointer border transition-all duration-300 ${
                    isActive
                      ? "bg-white dark:bg-slate-850 border-blue-200 dark:border-blue-900 shadow-xl shadow-blue-100/30 dark:shadow-none scale-[1.02]"
                      : "bg-white/50 dark:bg-slate-900/40 border-gray-100 dark:border-slate-850 hover:bg-white dark:hover:bg-slate-800 hover:border-gray-200 dark:hover:border-slate-700 hover:shadow-lg"
                  }`}
                >
                  {/* Icon & Number Badge */}
          ...
          <div className="lg:col-span-7 lg:sticky lg:top-24">
            <div className="bg-white/85 dark:bg-slate-900/85 backdrop-blur-xl border border-gray-200/60 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl shadow-blue-50/50 dark:shadow-none min-h-[460px] flex flex-col justify-between">
              ...
              <div className="flex-1 flex flex-col justify-center">
                ...
                {activeStep === 0 && (
                  <div className="max-w-md mx-auto w-full bg-slate-50 dark:bg-slate-950/40 border border-gray-100 dark:border-slate-850 rounded-2xl p-5 shadow-inner">
                    ...
                    {!simulationState.orgCreated ? (
                      ...
                      <div className="text-center py-6 space-y-4">
                        ...
                        <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-850 rounded-lg p-2 text-xs font-semibold text-gray-600 dark:text-gray-300 max-w-xs mx-auto truncate select-all cursor-pointer">
                      ...
                      {!simulationState.searchFinished ? (
                        ...
                        <div className="space-y-2.5">
                          ...
                          {simulationState.searchResults.map((result, idx) => (
                            <div
                              key={idx}
                              className="bg-slate-50 dark:bg-slate-950/40 border border-gray-100 dark:border-slate-850 p-3.5 rounded-xl flex justify-between items-start gap-4 hover:border-gray-200 dark:hover:border-slate-800 transition-colors"
                            >
                ...
                {activeStep === 4 && (
                  <div className="max-w-md mx-auto w-full space-y-5 bg-slate-50 dark:bg-slate-950/40 border border-gray-100 dark:border-slate-850 rounded-2xl p-5 shadow-inner">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-850 p-2.5 rounded-xl text-center">
                    ...
                    <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-850 rounded-xl p-3.5 space-y-2">
